 ...
 */
export declare class SlackBotWorker extends BotWorker {
    /**
     ...
     * @param userId A Slack user id, like one found in `message.user` or in a `<@mention>`
     */
    startConversationInChannel(channelId: string, userId: string): Promise<any>;
    /**
     ...
     */
    startConversationInThread(channelId: string, userId: string, thread_ts: string): Promise<any>;
    /**
     ...
     * @param resp an outgoing message object (or part of one or just reply text)
     */
    replyEphemeral(src: any, resp: any): Promise<any>;
    /**
     ...
     * @param resp an outgoing message object (or part of one or just reply text)
     */
    replyPublic(src: any, resp: any): Promise<any>;
    /**
     ...
     * @param resp an outgoing message object (or part of one or just reply text)
     */
    replyPrivate(src: any, resp: any): Promise<any>;
    /**
     ...
     */
    replyInteractive(src: any, resp: any): Promise<any>;
    /**
     ...
     */
    replyWithDialog(src: any, dialog_obj: Dialog): Promise<any>;
    /**
